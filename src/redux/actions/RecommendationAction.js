...
function android_doing(data, isRefreshing, isLoadging) {
    return {
        type: Type.recommondation.RECOMMONDATION_DOING, data: data,
        isRefreshing: isRefreshing, isLoading: isLoadging
    }
}

function android_done(data) {
    return {type: Type.recommondation.RECOMMONDATION_DONE, data: data}
}

function android_error(data) {
    return {type: Type.recommondation.RECOMMONDATION_ERROR, data: data}
}